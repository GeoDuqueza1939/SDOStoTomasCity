...
### TO DO (BACKLOGS):
* [ ] Progress Report on SERGS Development (Narrative)

### ON-GOING:
* [ ] Database construction
* [ ] ERD Diagram (database)
* [ ] UML Diagram (front-end/JS)
* [ ] UML Diagram (back-end/PHP)
* [ ] Technical Manual (Priority 1)
* [ ] User Manual (Priority 1)

### ON HOLD:
* [ ] Prototype (Priority 1)
* [ ] Wireframes (front-end)

### FINISHED:
* [ ] User Stories and Scenarios-Set 1
* [ ] Workflow Chart
___
