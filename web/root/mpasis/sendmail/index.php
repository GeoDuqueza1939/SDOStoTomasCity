...
{ ?>
    <main id="email-composer">
        <form id="email-composer-form" name="email-composer-form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>?sending" enctype="multipart/form-data">
            ...
            <label for="cc">CC:</label> <br><input id="cc" name="cc" type="email" value="<?php echo (isset($_REQUEST['cc']) ? $_REQUEST['cc'] : ''); ?>" placeholder="Enter email address"><br>
            <label for="bcc">BCC:</label> <br><input id="bcc" name="bcc" type="email" value="<?php echo (isset($_REQUEST['bcc']) ? $_REQUEST['bcc'] : ''); ?>" placeholder="Enter email address"><br>
